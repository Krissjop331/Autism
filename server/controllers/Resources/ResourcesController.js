...
class ResourcesController {
    ...
    async create(req, res) {
        ...
        if(resourcesDublicate) return CustomError.handleDuplicateResource(res, "Данные ресурс уже существует с таким названием");
        ...
        if(!resources) return res.status(500).json({message: "Ресурс создать не удалось"})
        ...
        resources = [...resources, resourcesModule, resourcesType];

        return res.status(200).json({message: "Данные получены", resources});
    }
